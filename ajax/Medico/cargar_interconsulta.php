<?php
    ...
    $sql = "SELECT H.cod_atencion_interconsulta, E.DES_ESPECIALIDAD 
	...
	while($row = sqlsrv_fetch_array($res)) {
        $id = $row['cod_atencion_interconsulta'];
        $nombre = $row['DES_ESPECIALIDAD'];
        
		$html .= "<tr><td width='1000'><input readonly type='text' class='form-control' value='$nombre'/></td><td><button type='button' onclick='quitar_interconsulta($id)' class='btn btn-danger'><i class='fa fa-minus'></i></button></td></tr>";
	}
